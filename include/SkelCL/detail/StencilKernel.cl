...
__kernel void SCL_STENCIL(__global SCL_TYPE_0* SCL_IN, __global SCL_TYPE_1* SCL_OUT, const unsigned int SCL_ELEMENTS,
...
*/
        if(row<SCL_ELEMENTS/SCL_COLS && col<SCL_COLS) {
                ...
                SCL_OUT[row*SCL_COLS+col+SCL_COLS*SCL_NORTH] = USR_FUNC(&(SCL_IN[row*SCL_COLS+col+SCL_NORTH*SCL_COLS]));
